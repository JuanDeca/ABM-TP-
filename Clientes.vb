...
Public Class Clientes
    ...
    Sub buscar(ByVal condicion As String)
        ...
        Dim da As New SqlDataAdapter("SELECT TOP (100) PERCENT ncli, apellido from [Sistema].[dbo].[Clientes] where " & condicion & " order by apellido", con)
    ...
    Sub CargarCamposProfesores()
        ...
        Else
            ...
            TextBox6.Text = ds.Tables("Clientes").Rows(0)("teléfono")
            ...
            TextBox9.Text = ds.Tables("Clientes").Rows(0)("cuit")
            TextBox10.Text = ds.Tables("Clientes").Rows(0)("usuario")
            TextBox11.Text = ds.Tables("Clientes").Rows(0)("clave")
        End If
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If SQL_Accion("delete from [Sistema].[dbo].[Clientes]  where  ncli=" & Val(lLegajo.Text)) = False Then
    ...
    Private Sub bNuevoProfesor_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bNuevoAlumno.Click
        If SQL_Accion("insert into [Sistema].[dbo].[Clientes] (apellido, nombre, [documento],domicilio, localidad, teléfono, fechanacimiento, comentarios,[email],estado, cuit, usuario, clave) values ('*****','*****',                  0,           '',           '',             '',           getdate(),               ''       ,      ''    ,     1 , '', '', ''  )  ") Then
